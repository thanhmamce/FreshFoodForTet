...
protocol ActivitiesViewInterface: BaseViewInterface {
    
}

class ActivitiesViewController: BaseViewController {
    fileprivate var presenter: ActivitiesPresenterInterface?
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        presenter = basePresenter as? ActivitiesPresenterInterface
...
extension ActivitiesViewController: PopOverViewDelegate {
...
extension ActivitiesViewController: ActivitiesViewInterface {
